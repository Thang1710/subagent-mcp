...
| Recursive orchestration | Strict declared MCP and explicit Codex/AgentBridge/Subagent MCP deny rules |
...
does not own existing Codex/Claude/AgentBridge configuration, auth, cache,
...
In `0.1.0a1`, project/local `CLAUDE.md`, `.claude` hooks, agents, skills, and
