...
> **Stable:** `1.0.9` targets Windows. The MCP, package, localhost UI, and
...
codex mcp add subagent-mcp -- uvx --isolated --from subagent-harness-mcp==1.0.9 subagent-harness-mcp serve
uvx --isolated --from subagent-harness-mcp==1.0.9 subagent-harness-mcp ui --background
```
...
version. This example upgrades 1.0.7 to 1.0.9:

```powershell
uvx --isolated --from subagent-harness-mcp==1.0.7 subagent-harness-mcp ui --stop
