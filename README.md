...
> **Preview:** `0.1.0a28` targets Windows. The MCP, package, localhost UI, and
...
uv tool install subagent-harness-mcp==0.1.0a28
codex mcp add subagent-mcp -- uvx --from subagent-harness-mcp==0.1.0a28 subagent-harness-mcp serve
```
...
uv tool install --reinstall subagent-harness-mcp==0.1.0a28
