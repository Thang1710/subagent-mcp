...
> **Stable:** `1.0.24` targets Windows. The MCP, package, localhost UI, and
...
codex mcp add subagent-mcp -- uvx --isolated --from subagent-harness-mcp==1.0.24 subagent-harness-mcp serve
...
version. This example upgrades 1.0.23 to 1.0.24:
