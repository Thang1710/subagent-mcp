...
> **Stable:** `1.0.25` targets Windows. The MCP, package, localhost UI, and
...
codex mcp add subagent-mcp -- uvx --isolated --from subagent-harness-mcp==1.0.25 subagent-harness-mcp serve
uvx --isolated --from subagent-harness-mcp==1.0.25 subagent-harness-mcp ui --background
```
...
version. This example upgrades 1.0.23 to 1.0.25:

```powershell
uvx --isolated --from subagent-harness-mcp==1.0.23 subagent-harness-mcp ui --stop
