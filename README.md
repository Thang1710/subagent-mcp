...
> **Stable:** `1.0.14` targets Windows. The MCP, package, localhost UI, and
...
uvx --isolated --from subagent-harness-mcp==1.0.14 subagent-harness-mcp ui --background
```
...
version. This example upgrades 1.0.13 to 1.0.14:
